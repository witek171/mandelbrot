...
namespace Mandelbrot.Core.Rendering
{
    public readonly struct ViewPort
    {
        ...
        /// <summary>
        /// Czy zbliżamy się do limitu precyzji double
        /// </summary>
        public bool IsNearPrecisionLimit => Width < 1e-13;
        ...
        {
            return $"{MinReal:G17}_{MaxReal:G17}_{MinImaginary:G17}_{MaxImaginary:G17}_{width}_{height}_{maxIter}";
        }
    }
}