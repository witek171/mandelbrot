...
namespace Mandelbrot.Core.Rendering
{
    public class ColorPalette
    {
        ...
        {
            Rainbow, Fire, Ocean, Grayscale,
            Electric, Sunset, Forest, Neon
        }
        ...
        private static Color Rainbow(double t) => FromHsv(t * 360, 1, 1);
        ...
        private static Color Electric(double t) => FromHsv(240 + t * 60, 1, 0.5 + t * 0.5);
        ...
        private static Color Neon(double t) => FromHsv((t * 120 + 280) % 360, 1, 1);
